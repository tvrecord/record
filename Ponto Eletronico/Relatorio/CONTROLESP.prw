...
ฑฑบPrograma  ณCONTROLESPบ Autor ณ Bruno Alves        บ Data ณ  19/09/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ cONTROLE DE ESPELHO DE PONTO REFERENTE AO MES		      บฑฑ
ฑฑบ                                                                       บฑฑ
...
Local Cabec1       := "Mat.    Nome                                              Fun็ใo                                            Situa็ใo"
Local Cabec2       := ""
Local imprime      := .T.
Local aOrd := {}
Private lEnd         := .F.
...
Private limite           := 120
Private tamanho          := "M"
Private nomeprog         := "CONTROLESP" // Coloque aqui o nome do programa para impressao no cabecalho
Private nTipo            := 18
Private aReturn          := { "Zebrado", 1, "Administracao", 2, 2, 1, "", 1}
Private nLastKey        := 0
Private cPerg       := "CONTR122"
Private cbtxt      := Space(10)
Private cbcont     := 00
Private CONTFL     := 01
Private m_pag      := 01
Private wnrel      := "CONTROLESP" // Coloque aqui o nome do arquivo usado para impressao em disco
Private cString := "SRA"
Private cQuery := ""
...
If MV_PAR07 == 2
titulo  := "RECEBIMENTO DE ESPELHO DE PONTO - " + MES(MV_PAR06) + "/" + SUBSTR(DTOS(MV_PAR06),1,4)
Else
titulo  := "RECEBIMENTO - CONTRA CHEQUE - " + MES(MV_PAR06) + "/" + SUBSTR(DTOS(MV_PAR06),1,4)
EndIf
...
EndIf
cQuery += "SRA010.RA_ADMISSA <= '" + DTOS(MV_PAR06) + "' AND "
If MV_PAR07 == 2
cQuery += "SRJ010.RJ_ASSPON = '1' AND "
EndIf
...
cQuery += "SRA010.RA_CATFUNC <> 'E' AND "
EndIf
cQuery += "SRA010.RA_DEMISSA >= '" + SUBSTR(DTOS(MV_PAR06),1,6) + "01" + "' AND " 
If MV_PAR07 == 2
cQuery += "SRJ010.RJ_ASSPON = '1' AND "
EndIf
cQuery += "SRJ010.D_E_L_E_T_ <> '*' AND "
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบFuno    ณRUNREPORT บ Autor ณ AP6 IDE            บ Data ณ  06/09/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescrio ณ Funcao auxiliar chamada pela RPTSTATUS. A funcao RPTSTATUS บฑฑ
ฑฑบ          ณ monta a janela com a regua de processamento.               บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
15267ฑฑบUso       ณ Programa principal                                         บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
/*/
...
Aadd(aRegs,{cPerg,"06","Ate Admissao ?","","","mv_ch6","D",08,0,0,"G","","mv_par06","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
Aadd(aRegs,{cPerg,"07","Recebimento ?","","","mv_ch7","N",01,0,0,"C","","mv_par07","Folha","Folha","Folha","","","Esp. Ponto","Esp. Ponto","Esp. Ponto","","","","","","","","","","","","","","","","","","","",""} )
Aadd(aRegs,{cPerg,"08","Estagiario ?","","","mv_ch8","N",01,0,0,"C","","mv_par08","Sim","","","","","Nao","Nao","Nao","","","","","","","","","","","","","","","","","","","",""} )
