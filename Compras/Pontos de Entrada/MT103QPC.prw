...
±±ºPrograma  ³MT103QPC   ºAutor  ³Rafael Franca      º Data ³  16/03/21   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Programa para selecionar pedidos de lojas diferentes        º±±
...
Local cQry:=ParamIxb[1] //Query padrão do sistema
