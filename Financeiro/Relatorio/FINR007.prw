...
,E1_NUM AS NOTA,E1_CLIENTE AS CLIENTE,E1_NOMCLI AS NOME_CLI
...
While !(cAlias)->(Eof())
	...
	//Criando as Linhas
    oFWMsExcel:AddRow("Comissão de Agências",cNomeTabela,{MES, AGENCIA, NOME, NOTA, CLIENTE, NOME_CLI, DTOC(STOD(EMISSAO)), DTOC(STOD(VENCIMENTO)), VALOR, COMISSAO, NATUREZA, DESCRICAO, DTOC(STOD(BAIXA)) })
