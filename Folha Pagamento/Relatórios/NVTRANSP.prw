...
±±ºPrograma  ³NVTRANSPº Autor ³ Bruno Alves        º Data ³  04/08/14   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ º±± Impressão do pagamento dos vales transportes
±±º          ³ º±±
...
Local Cabec1         := "Mat.    Nome                                     Admissao Fim Contrat  Ini Ferias   Fim Ferias       Total       Desconto      Cod     Empresa           Valor QTD"
Local Cabec2         := ""
Local Cabec3         := ""
Local imprime        := .T.
Local aOrd := {}
...
Private limite       := 180
Private tamanho      := "G"
Private nomeprog     := "NVTRANSP" // Coloque aqui o nome do programa para impressao no cabecalho
Private nTipo        := 15
...
cQuery := "SELECT RA_FILIAL,RA_MAT,RA_NOME,RA_ADMISSA,RA_VCTOTEM,RA_SALARIO,RA_CATFUNC,RA_CC,RG2_PERIOD,RG2_CODIGO,RG2_CUSFUN,RG2_VALCAL,RG2_DIACAL FROM SRA010 "
cQuery += "INNER JOIN RG2010 ON "
cQuery += "RG2010.RG2_FILIAL = SRA010.RA_FILIAL AND "
cQuery += "RG2010.RG2_MAT = SRA010.RA_MAT "
cQuery += "WHERE "
...
cQuery += "RG2010.RG2_DIACAL <> 0 AND "
cQuery += "SRA010.D_E_L_E_T_ <> '*' AND "
cQuery += "RG2010.D_E_L_E_T_ <> '*' AND "
cQuery += "RG2010.RG2_PERIOD = '" + SUBSTR(DTOS(MV_PAR04),1,6) + "' "
If MV_PAR06 == 1
...
While !EOF()
	...
	DBSelectARea("SRN")
	DBSetOrder(1)
	DBSeek(xFilial("SRN") + TMP->RG2_CODIGO)
	...
	If lOk1 == .T.
		...
		@nLin, 086 PSAY " / / "
	EndIf
	@nLin, 098 PSAY TMP->RG2_VALCAL PICTURE "@E 999,999.99"
	@nLin, 110 PSAY TMP->RG2_CUSFUN PICTURE "@E 999,999.99"
	@nLin, 128 PSAY TMP->RG2_CODIGO
	@nLin, 135 PSAY SRN->RN_DESC
	@nLin, 152 PSAY SRN->RN_VUNIATU  PICTURE "@E 999.99"
	@nLin, 160 PSAY TMP->RG2_DIACAL 
	
	cMat        := TMP->RA_MAT
	nTot     	+= TMP->RG2_VALCAL
	nDescTot 	+= TMP->RG2_CUSFUN
	nTotCC		+= TMP->RG2_VALCAL
	cCustos  	:= TMP->RA_CC
	nDescTotcc  += TMP->RG2_CUSFUN
	...
	IF (TMP->RA_CC != cCustos)
		...
		@nLin, 110 PSAY nDescTotCC PICTURE "@E 999,999.99"
		nLin := nLin + 1 // Avanca a linha de impressao            "
		@nLin, 000 PSAY REPLICATE("-",220)
