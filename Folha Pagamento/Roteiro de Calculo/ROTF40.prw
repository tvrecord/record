...
If SRA->RA_HEFIX25 == "S" // H.E FIXA CONTRATUAL 25 
	HorasExtras:=((((nBase + fbuscapd("333") + fbuscapd("334"))/SRA->RA_HRSMES) * 1.7)*25) 
	DsrHorasExtra:=((HorasExtras/_nDUteis)*_nDiasDSR)
	/*
	fGeraVerba("562", 1411.01,nDiasFer,,,,,,,,.T.) 
	fGeraVerba("564", 217.08,(RH_DFERIAS - nDiasFer),,,,,,,,.T.) 
	fGeraVerba("996", 1628.09,70,,,,,,,,.T.)
	fGeraVerba("563", 282.20,nDiasFer,,,,,,,,.T.) 
	fGeraVerba("565", 43.42,(RH_DFERIAS - nDiasFer),,,,,,,,.T.) 
	fGeraVerba("998", 325.62,,,,,,,,,.T.)
	*/ 	
