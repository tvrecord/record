...
If (SF4->(DBSEEK(XFILIAL('SF4')+SD1->D1_TES)))
	If SF4->F4_CTBDESP=="1"
		...
		If  cTempConta >= '41' .AND. cTempConta <= '439999999'
			...
			cGrupo 		:= Posicione("CTT",1,xFilial("CTT") + IIF(SUBSTR(SD1->D1_CONTA,1,1)$"3,4",SD1->D1_CC,''),"CTT_GRUPO")// Busca o grupo do plano de contas no cadastro do centro de custo
