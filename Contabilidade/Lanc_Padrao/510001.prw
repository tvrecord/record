...
±±ºPrograma  ³505001ºAutor  ³Microsiga           º Data ³  01/03/13   º±±
...
If SED->ED_CONTA >= '41' .AND. SED->ED_CONTA <= '439999999'
	...
	cGrupo := Posicione("CTT",1,xFilial("CTT") + IIF(SE2->E2_CCD==" ", " ",SE2->E2_CCD), "CTT_GRUPO")// Busca o grupo do plano de contas no cadastro do centro de custo
