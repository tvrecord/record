...
If (SF4->(DBSEEK(XFILIAL('SF4')+SD1->D1_TES)))
	If SF4->F4_CTBDESP=="1"
		...
		If  cTempConta >= '41' .AND. cTempConta <= '439999999'
			...
			cGrupo 		:= Posicione("CTT",1,xFilial("CTT") + IIF(SDE->DE_CC==" ", " ",SDE->DE_CC),"CTT_GRUPO")// Busca o grupo do plano de contas no cadastro do centro de custo
