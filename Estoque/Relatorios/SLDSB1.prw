...
±±ºPrograma  ³SLDSB1    º Autor ³RAFAEL FRANCA       º Data ³  21/05/12   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³SALDOS DOS PRODUTOS DA TABELA SB1                           º±±
±±º          ³                                                            º±±
...
Local cDesc3        := "Saldo estoque"
Local cPict         := ""
Local titulo       	:= "Saldo estoque"
Local nLin         	:= 80

Local Cabec1       	:= ""
Local Cabec2       	:= ""
Local imprime      	:= .T.
Private aOrd        := {"Grupo","Endereço"}
Private lEnd        := .F.
Private lAbortPrint := .F.
Private CbTxt       := ""
Private limite      := 132
Private tamanho     := "M"
Private nomeprog    := "SLDSB1" // Coloque aqui o nome do programa para impressao no cabecalho
Private nTipo       := 18
Private aReturn     := {"Zebrado",1,"Administracao",2,2,1,"",1}
Private nLastKey    := 0
Private cPerg       := "SLDSB1"
Private cbtxt      	:= Space(10)
Private cbcont     	:= 00
Private CONTFL     	:= 01
Private m_pag      	:= 01
Private wnrel      	:= "SLDSB1" // Coloque aqui o nome do arquivo usado para impressao em disco
...
AADD(aRegs,{cPerg,"01","Do  Produto	","","","mv_ch01","C",10,0,0,"G","","mv_par01","","","","","","","","","","","","","","","","","","","","","","","","","SB1"})
AADD(aRegs,{cPerg,"02","Ate Produto	","","","mv_ch02","C",10,0,0,"G","","mv_par02","","","","","","","","","","","","","","","","","","","","","","","","","SB1"})
AADD(aRegs,{cPerg,"03","Do  Grupo	","","","mv_ch03","C",04,0,0,"G","","mv_par03","","","","","","","","","","","","","","","","","","","","","","","","","SBM"})
AADD(aRegs,{cPerg,"04","Ate Grupo 	","","","mv_ch04","C",04,0,0,"G","","mv_par04","","","","","","","","","","","","","","","","","","","","","","","","","SBM"})
AADD(aRegs,{cPerg,"05","Da  Armazem	","","","mv_ch05","C",02,0,0,"G","","mv_par05","","","","","","","","","","","","","","","","","","","","","","","","",""})
AADD(aRegs,{cPerg,"06","Ate Armazem","","","mv_ch06","C",02,0,0,"G","","mv_par06","","","","","","","","","","","","","","","","","","","","","","","","",""})
AADD(aRegs,{cPerg,"07","Salta pag	","","","mv_ch07","N",01,0,2,"C","","mv_par07","Sim","","","","","Nao","","","","","","","","","","","","","","","","","","","","","","",""})
